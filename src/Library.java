public class Library {
  public static void main(String[] args) {
    ...
    // Bookshelf should have a toString() method which give us information about the number of books, the earliest and
    // the latest released books, and the favourite author
